        ...
        <>
            <main>
                ...
                <div className='w-full h-screen rounded-ss-4xl bg-gray-200 py-5'>
                    <br />
                    <form className="max-w-sm mx-auto" ref={form}>
                        <div className="mb-5">
                        ...
                        <button type="submit" onClick={() => login(form)} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register new account</button>
                    </form>
