    ...
    <>
        <section className='relative z-10 container mx-auto px-4 pb-2 grid grid-cols-2 gap-2'>
          ...
          <div className="flex flex-row cursor-pointer rounded-lg bg-gray-50 p-4 hover:bg-gray-100">
            ...
            <div className="mx-auto mb-2 flex h-[48px] max-h-[48px] w-[48px] max-w-[48px] items-center justify-center rounded-full bg-gray-200 p-2">
              <svg className="inline h-5 w-5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
